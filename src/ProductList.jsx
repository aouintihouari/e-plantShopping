...
function ProductList({ onHomeClick }) {
  ...
  const addedPlants = useSelector((state) => state.cart.items);
  const totalQuantity = addedPlants.reduce(
  ...
  return (
    <div>
      ...
      {!showCart && showPlants ? (
            ...
            <div key={index}>
              ...
              <div className="product-list">
                {category.plants.map((plant, plantIndex) => {
                  const isInCart = addedPlants.some(
        ...
        <CartItem onShowPlants={setShowPlants} onShowCart={setShowCart} />
      )}
    </div>
  );
}
